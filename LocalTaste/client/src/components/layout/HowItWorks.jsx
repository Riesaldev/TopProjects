        ...
        <div className="grid grid-cols-1 md:grid-cols-3 justify-around">
          ...
          <div className="flex relative flex-col w-72 gap-4 p-4 rounded-2xl bg-[#e6f9e9]/50 border border-green-300/50 hover:shadow-lg hover:scale-115 transition-all ease-in-out duration-400">
            ...
            <div className="flex flex-col gap-2">
              ...
              <p className="text-[#4c9a6c] pr-8 pl-1 text-sm leading-normal ">Navega por perfiles de granjas locales cercanas a ti y selecciona tus favoritos.</p>
            </div>
          </div>
          {/* Step 2 */}
          <div className="flex relative flex-col w-72 gap-4 p-4 rounded-2xl bg-[#e6f9e9]/50 border border-green-300/50 hover:shadow-lg hover:scale-115 transition-all ease-in-out duration-400">
            ...
            <div className="flex flex-col gap-2">
              ...
              <p className="text-[#4c9a6c] pr-8 pl-1 text-sm leading-normal">Mezcla y combina productos o elige una cesta sorpresa de temporada cada semana.</p>
            </div>
          </div>
          {/* Step 3 */}
          <div className="flex relative flex-col w-72 gap-4 p-4 rounded-2xl bg-[#e6f9e9]/50 border border-green-300/50 hover:shadow-lg hover:scale-115 transition-all ease-in-out duration-400">
            ...
            <div className="flex flex-col gap-2">
              ...
              <p className="text-[#4c9a6c] pr-8 pl-1 text-sm leading-normal">Entregas semanales flexibles y ecológicas directamente desde la granja a tu hogar.</p>
            </div>
          </div>
        </div>
      </div>
