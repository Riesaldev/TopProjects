...
export default function GameCard({ game, onSelect }: Props) {
  ...
  return (
    ...
    >
      ...
      <span className={`mb-2 inline-flex items-center rounded-full border px-2.5 py-1 text-[10px] font-black uppercase tracking-widest z-10 ${isTest ? "border-cyan-400/40 text-cyan-300 bg-cyan-500/10" : "border-violet-400/40 text-violet-300 bg-violet-500/10"}`}>
        {isTest ? "Test" : "Juego"}
      </span>
