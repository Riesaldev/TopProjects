      ...
      <div className="max-w-240 mx-auto flex flex-col md:flex-row items-center justify-between gap-10">
        ...
        <div className="flex-1 w-full max-w-md">
          <form className="flex flex-col sm:flex-row gap-3">
            ...
            <button className="px-4 py-2 text-green-950 bg-[#2BEE7C] font-bold text-sm rounded-2xl hover:text-[#9fecbf] hover:bg-green-900 cursor-pointer transition-all duration-500" type="button">
              Suscribirme
            </button>
          </form>
          <p className="text-xs text-gray-400 mt-3">Respetamos tu privacidad. Date de baja cuando quieras.</p>
        </div>
      </div>
    </section>
  );
