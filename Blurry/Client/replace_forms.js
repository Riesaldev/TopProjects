import fs from 'fs';
const loginFile = 'c:/Users/Ricardoea/OneDrive/Escritorio/TopProjects/Blurry/Client/src/components/LoginForm.tsx';
const registerFile = 'c:/Users/Ricardoea/OneDrive/Escritorio/TopProjects/Blurry/Client/src/components/RegisterForm.tsx';

const newLoginContent = `"use client";
...
const newRegisterContent = `"use client";
...
if(fs.existsSync(loginFile)) fs.writeFileSync(loginFile, newLoginContent);
if(fs.existsSync(registerFile)) fs.writeFileSync(registerFile, newRegisterContent);
